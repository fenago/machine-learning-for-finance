...
Chapter 2. Applying Machine Learning to Structured Data {#chapter-2.-applying-machine-learning-to-structured-data .title}
----------------------------------------------------------------
...
library, while this chapter makes extensive use of
...
[**Note**]: All of the libraries needed for this chapter are
...
Earlier in this chapter, we introduced the three
...
comes from the oversampling that we did earlier on in this
 chapter. Secondly, the training set\'s accuracy
