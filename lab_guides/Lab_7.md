...
12. We return the function. Since we call `actor_optimizer()`{.literal}
...
Again, we have built a[]{#id587 .indexterm} Keras model in a function.
...
3.  Compute the probability that the actions observed, [*D,*]{.emphasis}
    were a result of
